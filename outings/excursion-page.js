...
document.querySelector("#excursion-page").innerHTML = `
  <header class="site-header">
    ...
    <nav aria-label="Main navigation"><a href="../../index.html#gallery">The villa</a><a href="../../index.html#stays">Ways to stay</a><a href="../../index.html#explore">Explore</a><a class="nav-cta" href="../../index.html#inquire">Inquire</a></nav>
  </header>
  <main>
  ...
  <footer class="site-footer"><a class="brand footer-brand" href="../../index.html"><img src="../../assets/images/brand/brienz-villa-logo.png" alt=""><span>Brienz Villa</span></a><div><a href="mailto:info@brienzvilla.com">info@brienzvilla.com</a></div><div class="footer-links"><a href="../../index.html#explore">Explore outings</a><a href="https://airbnb.com/h/brienzvilla" target="_blank" rel="noopener">Airbnb ↗</a><a href="https://www.youtube.com/watch?v=6CjHJUKbVas" target="_blank" rel="noopener">YouTube ↗</a></div><p class="copyright">© ${new Date().getFullYear()} Brienz Villa</p></footer>`;
